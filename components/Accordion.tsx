...
interface AccordionItemProps {
  header: React.ReactNode; // Allow any valid React Node for the header
  actions: {
    heading: string;
    description: string;
  }[];
...
const AccordionItem: React.FC<AccordionItemProps> = ({ header, actions }) => {
  ...
  return (
    <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
      ...
      >
        ...
        <div className="w-full text-xl">{header}</div>
      </button>
